              ...
              {articles.map((article) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-3 sm:p-5">
                    ...
                    <Link
                      href="#contact"
                      className="mt-auto inline-flex items-center gap-2 pt-3 text-xs font-semibold text-[var(--color-text-secondary)] transition-colors hover:text-[#016502] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-text-secondary)] rounded-sm sm:pt-4 sm:text-[length:var(--text-sm)]"
                    >
                      Đọc thêm
                      <ArrowRight
