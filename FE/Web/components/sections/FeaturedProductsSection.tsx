          ...
          <div className="relative">
            ...
            >
              {products.map((product) => (
                <article
                  key={product.id}
                  className="group relative flex w-[calc((100%_-_12px)/2)] shrink-0 snap-start flex-col overflow-hidden rounded-2xl border border-[var(--color-border-subtle)] bg-[var(--color-surface-elevated)] transition-all duration-[400ms] hover:border-[var(--color-text-secondary)]/25 sm:w-[calc((100%_-_32px)/2)] sm:rounded-[var(--radius-card)] lg:w-[calc((100%_-_48px)/3)]"
                >
